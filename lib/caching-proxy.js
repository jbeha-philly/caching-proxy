    ...
    var SERVER = {
        ...
        serveQAStatus : function(req, res){
            ...
            var status = `document.addEventListener('DOMContentLoaded', function(){ 
                ...
                e.innerHTML = '<div style="background: red;position: fixed;z-index: 100001;margin-top: 2px; padding: 5px; font-size: 1em;">
                QA: ${SERVER.GIT_CONFIG.CODE},${SERVER.GIT_CONFIG.CONFIG},${SERVER.GIT_CONFIG.CONTENT}<br>${SERVER.GIT_CONFIG.DIRTY}
                </div>';
